...
export const penguinTheme: ThemeConfigExtended = {
  ...
  concepts: {
    ...
    liveView: "🐧 빙하 라이브 뷰",
    liveViewDescription: "우리 펭귄이 빙하에서 무엇을 하고 있는지 확인해보세요! ❄️",
...
export const desertFoxTheme: ThemeConfigExtended = {
  ...
  concepts: {
    ...
    liveView: "🦊 사막 라이브 뷰",
    liveViewDescription: "우리 사막여우가 오아시스에서 무엇을 하고 있는지 확인해보세요! 🌵",
...
export const sheepTheme: ThemeConfigExtended = {
  ...
  concepts: {
    ...
    liveView: "🐑 목초지 라이브 뷰",
    liveViewDescription: "우리 양이 목초지에서 무엇을 하고 있는지 확인해보세요! 🌱",
...
export const catTheme: ThemeConfigExtended = {
  ...
  concepts: {
    ...
    liveView: "🐱 고양이 집 라이브",
    liveViewDescription: "우리 고양이가 집에서 무엇을 하고 있는지 확인해보세요! 🐾",
    quickActions: "집 퀵 액션",
